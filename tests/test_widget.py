...
from src.bank_operations.widget import get_date, mask_account_card
...
@pytest.mark.parametrize(
    "invalid_input", ["Invalid String Without Number", "Счет 123", "", None]
)
...
@pytest.mark.parametrize("invalid_date", ["invalid-date", "", None])
